...
const file_src_proto_hello_proto_rawDesc = "" +
	"\n" +
	"\x15src/proto/hello.proto\x12\x05hello\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2B\n" +
	"\aGreeter\x127\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\"\x00B\"Z example.com/hello-grpc/src/protob\x06proto3"

var (
	file_src_proto_hello_proto_rawDescOnce sync.Once
	file_src_proto_hello_proto_rawDescData []byte
)

func file_src_proto_hello_proto_rawDescGZIP() []byte {
	file_src_proto_hello_proto_rawDescOnce.Do(func() {
		file_src_proto_hello_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_src_proto_hello_proto_rawDesc), len(file_src_proto_hello_proto_rawDesc)))
	})
	return file_src_proto_hello_proto_rawDescData
}

var file_src_proto_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_src_proto_hello_proto_goTypes = []any{
...
func file_src_proto_hello_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_src_proto_hello_proto_rawDesc), len(file_src_proto_hello_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
